<x-jet-action-section>
    <x-slot name="title">
        {{ __('Odjava sa svih sinkroniziranih uređaja') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Odjavite se sa svih sinkroniziranim uređajima') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Ako mislite da je Vaš korisnički račun kompromitiran, svakako promjenite lozinku.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Molimo unesite lozinku kako biste potvrdili da se želite odjaviti sa svih uređaja.') }}
